...
class TelegramBot:
    ...
    def _register_handlers(self):
        ...
        self.application.add_handler(CallbackQueryHandler(self.view_cart, pattern="^my_orders$"))
        self.application.add_handler(CallbackQueryHandler(self.confirm_order, pattern="^confirm_order$"))
